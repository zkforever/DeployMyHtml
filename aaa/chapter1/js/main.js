...
var paths = [    "chapter1/t/page2/data.json",
                 "chapter1/t/page3/data.json",
                 "chapter1/t/page4/data.json",
                 "",
                 "chapter1/c/clutchPage1/data.json",
                 "chapter1/c/clutchPage2/data.json",
                 "chapter1/c/clutchPage3/data.json",
                 "chapter1/c/clutchPage4/data.json",
                 "chapter1/c/clutchPage5/data.json",
                 ""
                 ];//json的地址
...
function initBodyPages(page) {
    if (page == 1 || page == 5) {
        ...
        return;
         ...
         initBody(10,function(){
            resetPage(currentPage);
        });
        return;
    }
    if (page == 4) {
        initBodyBlock(page,page+2,page-1); 
    }else {
...
function initQuest1Data(){
    ...
    var btnArray = ["动力损耗小","直线行驶稳定性好","操控性好","节省空间","在急转弯时如果驱动力过大容易甩尾","空间利用率更高","空间小","易推头","制动性强","易转向不足"];
